                ...
                <div class="carousel-item active">
                    <div class="hero-slide d-flex flex-column justify-content-center align-items-center" style="min-height: 450px; background: linear-gradient(rgba(26, 61, 93, 0.85), rgba(26, 61, 93, 0.7)), url('/appsem/le palais à Kinshasa photo John Bompengo (12).JPG') center center / cover no-repeat;">
                        <div class="container">
                            ...
                            <a href="/appsem/public/contact.php" class="btn btn-outline-light btn-lg">Nous contacter</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                    ...
                    <a href="/appsem/public/vocation.php" class="btn btn-primary">En savoir plus</a>
                </div>
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-6 mb-4">
                            <img src="/appsem/public/images/musique.png" alt="Musique au séminaire" class="img-fluid rounded shadow" style="object-fit:cover; width:100%; height:160px;">
                        </div>
                        <div class="col-6 mb-4">
                            <img src="/appsem/public/images/batiment.png" alt="Bâtiment du séminaire" class="img-fluid rounded shadow" style="object-fit:cover; width:100%; height:160px;">
                        </div>
                        <div class="col-6">
                            <img src="/appsem/public/images/foret.png" alt="Forêt autour du séminaire" class="img-fluid rounded shadow" style="object-fit:cover; width:100%; height:160px;">
                        </div>
                        <div class="col-6">
                            <img src="/appsem/public/images/court.png" alt="Cour du séminaire" class="img-fluid rounded shadow" style="object-fit:cover; width:100%; height:160px;">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3">
                    <div class="feature-box">
                        ...
                        <a href="/appsem/public/formation-spirituelle.php" class="btn btn-outline-primary btn-sm mt-3">En savoir plus</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="feature-box">
                        ...
                        <a href="/appsem/public/formation-intellectuelle.php" class="btn btn-outline-primary btn-sm mt-3">En savoir plus</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="feature-box">
                        ...
                        <a href="/appsem/public/formation-pastorale.php" class="btn btn-outline-primary btn-sm mt-3">En savoir plus</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="feature-box">
                        ...
                        <a href="/appsem/public/formation-humaine.php" class="btn btn-outline-primary btn-sm mt-3">En savoir plus</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="/appsem/public/actualites.php" class="btn btn-primary w-100">Voir tous les événements</a>
                        </div>
                    </div>
                    ...
                    <div class="mass-schedule mt-4">
                        ...
                        <a href="/appsem/public/messes.php" class="btn btn-outline-primary btn-sm w-100 mt-3">Voir tous les horaires</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="galerie" class="py-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="gallery-item">
                        <img src="/appsem/public/images/messe.png" alt="Messe" class="img-fluid">
                ...
                <div class="col-md-4">
                    <div class="gallery-item">
                        <img src="/appsem/public/images/ensemble.png" alt="Ensemble" class="img-fluid">
                        <div class="gallery-overlay">
                ...
                <div class="col-md-4">
                    <div class="gallery-item">
                        <img src="/appsem/public/images/foret.png" alt="Forêt" class="img-fluid">
                        <div class="gallery-overlay">
            ...
            <div class="text-center mt-4">
                <a href="/appsem/public/archives.php" class="btn btn-primary">Voir toute la galerie</a>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="support-option">
                        ...
                        <a href="/appsem/public/don-argent.php" class="btn btn-outline-primary btn-sm mt-3">Faire un don</a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="support-option">
                        ...
                        <a href="/appsem/public/don-nature.php" class="btn btn-outline-primary btn-sm mt-3">Faire un don en nature</a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="support-option">
                        ...
                        <a href="/appsem/public/parrainage.php" class="btn btn-outline-primary btn-sm mt-3">Parrainer un séminariste</a>
                    </div>
                </div>
            </div>
